...
<html lang="en">
           ...
           <!-- Contact Form  -->
            <form id="request_form" onsubmit="return false" autocomplete="off">
              <div class="form-group">
                <input name="cus_name" id="cus_name" type="text" class="form-control" placeholder="Your Name">
                <small id="cre_error" class="form-text text-muted"></small>
              </div>

              <div class="form-group">
                <input name="cus_email" id="cus_email" type="text" class="form-control" placeholder="Your Email">
                <small id="cre_error" class="form-text text-muted"></small>
              </div>
              
              <div class="form-group">
                <input  name="cus_subject" id="cus_subject" type="text" class="form-control" placeholder="Subject">
                <small id="crs_error" class="form-text text-muted"></small>
              </div>

              <div class="form-group">
                <textarea name="cus_messages" id="cus_messages" cols="30" rows="7" class="form-control" placeholder="Messages"></textarea>
  ...
  <script src="https://maps.googleapis.com/maps/api/js?key=AIzaSyD9r2_i-srh58GhVt8Lucl8zEbakc1RLh0&sensor=false"></script>
